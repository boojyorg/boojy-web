...
/**
 * Full account view (Supabase auth + Stripe billing). Rendered as a client:only island —
 * it has no SEO value (behind login) and touches browser-only APIs, so there is nothing
 * to server-render. Billing UI is gated by CLOUD_LAUNCHED via the hook's showBillingUi.
 */
      ...
      <div className="account-container">
        {!user ? (
          ...
          <div id="dashboard-view">
            ...
            {showBillingUi ? (
              <>
                <div className="account-section-header" style={{ marginTop: 'var(--spacing-2xl)' }}>
                  <span>STORAGE</span>
                  <hr />
                </div>
